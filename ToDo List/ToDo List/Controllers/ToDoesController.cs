...
{
    //Попробовал делать разными способами, через репозиторий получилось. Потом захотел сделать через автогенирацию, меня конечно это впечатлило. Решил отсавить так.
